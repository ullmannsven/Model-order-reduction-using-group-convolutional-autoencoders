...
from torchpdes.models.instationary.pod_lspg_utilities_IMR import POD_LSPG_quasi_newton
...
def test_wave_2D():
    ...
    for i in range(nt):
        ...
        ## Quasi Newton:
        u_new = POD_LSPG_quasi_newton(reduced_basis, u_n1, mu_test, dt, fom, u_ref, tol=1e-8)
        ## End Quasi Newton
