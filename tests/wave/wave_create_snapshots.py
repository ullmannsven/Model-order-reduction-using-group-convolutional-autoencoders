...
def create_snapshots():
    ...
    parameter_space = fom.parameters.space(0.5, 1.5)
    ...
    for i, mu in enumerate(train_params):
            ...
            filename = f'snapshots_grid/snapshots_{Nx}x{Ny}_sigpre_{sig_pre_tag}_{number_of_snapshots}_{i}_nt_{nt}_every_{timestep_factor}_ts'
