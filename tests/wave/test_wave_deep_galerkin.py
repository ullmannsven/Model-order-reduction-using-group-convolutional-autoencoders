...
def test_wave_2D_new():
    ...
    nn_save_filepath = filepaths['checkpoints'] / "wave_2D_CNN_p_12_256x256_t_16_11_2025-13_56_01_scaled_larger_stride_nolr_00005.pt"
    network_parameters_file = filepaths['network_parameters'] / "wave_2D_CNN_p_12_256x256_t_16_11_2025-13_56_01_scaled_larger_stride_nolr_00005.pkl"
    ...
    for i in range(config.n_timesteps):
        ...
        # Quasi-Newton solve
        u_new = Galerkin_quasi_newton(model, u_n1, mu_test, config.dt, experiment.fom, u_ref, scaled_data, tol=1e-8)
