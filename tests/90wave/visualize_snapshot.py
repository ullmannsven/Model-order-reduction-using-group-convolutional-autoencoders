...
config = WaveExperimentConfig(x_flow=True, nt=500, timestep_factor=1, visualize_q=True)
...
torch_path = filepaths['snapshots'] / "snapshots_256x256_060_nt_500"
...
#experiment.fom.visualize(space2.from_numpy(snapshot[:, 50]))
